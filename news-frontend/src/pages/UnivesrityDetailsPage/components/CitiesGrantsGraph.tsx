  ...
  return (
    ...
    >
      ...
      <div style={{margin: '20px'}}>
            <Doughnut
                data = {{
                    labels:['Не указано', 'Акмолинская', 'Актобе', 'Алматы', 'Астана', 'Атырау', 'Города с Восточного Казахстана(не перечислененные ранее)', 'Жамбыл', 'Города с Западного Казахстана(не перечислененные ранее)',
